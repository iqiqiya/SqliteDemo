...
public class ApiOperateDatabase extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SQLiteOpenHelper helper = new SQLiteOpenHelper(this,path,null,2) {
            ...
            public void onCreate(SQLiteDatabase sqLiteDatabase) {
                //创建
                Toast.makeText(ApiOperateDatabase.this,"数据库创建",Toast.LENGTH_SHORT).show();
            ...
            public void onUpgrade(SQLiteDatabase sqLiteDatabase, int i, int i1) {
                //升级
                Toast.makeText(ApiOperateDatabase.this,"数据库升级",Toast.LENGTH_SHORT).show();
            }
        };
